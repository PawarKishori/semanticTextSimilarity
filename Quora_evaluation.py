...
tf.flags.DEFINE_string("vocab_filepath", "runs/1494974449/checkpoints/vocab", "Load training time vocabulary (Default: None)")
tf.flags.DEFINE_string("model", "runs/1494974449/checkpoints/model-177000", "Load trained model checkpoint (Default: None)")
