...
tf.flags.DEFINE_string("vocab_filepath", "runs/1493573691/checkpoints/vocab", "Load training time vocabulary (Default: None)")
tf.flags.DEFINE_string("model", "runs/1493573691/checkpoints/model-679000", "Load trained model checkpoint (Default: None)")
