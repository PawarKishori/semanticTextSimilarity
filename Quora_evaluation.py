...
tf.flags.DEFINE_string("vocab_filepath", "runs/1494522631/checkpoints/vocab", "Load training time vocabulary (Default: None)")
tf.flags.DEFINE_string("model", "runs/1494522631/checkpoints/model-396000", "Load trained model checkpoint (Default: None)")
